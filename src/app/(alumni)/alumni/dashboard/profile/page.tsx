'use client';
import { Alumni, AlumniProfileResponse } from "@/types/ApiResponse";
...
export default function ProfilePage () {
    ...
    const fetchProfile = async () => {
      try {
        setIsLoading(true);
        const response = await axios.get<AlumniProfileResponse>("/api/alumni/me");
        const message = response.data.message;
        toast.success(message);
        setImageSrc(response.data.alumni.ProfilePictureUrl);
        setAlumni(response.data.alumni);
      } catch (error) {
        const axiosError = error as AxiosError<AlumniProfileResponse>;
        const message =
